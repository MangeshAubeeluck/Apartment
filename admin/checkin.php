	...
	<div class = "container-fluid">	
		<div class = "panel panel-default">
			...
			<div class = "panel-body">
				<a class = "btn btn-success" href = "book.php"><span class = "badge"><?php echo $f_p['total']?></span> Pendings</a>
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$query = $conn->query("SELECT * FROM `transaction` NATURAL JOIN `guest` NATURAL JOIN `apartments` WHERE `status` = 'Check In'") or die(mysqli_query());
						...
						<tr>
							...
							<td><center><a class = "btn btn-warning" href = "checkout_query.php?transaction_id=<?php echo $fetch['transaction_id']?>" onclick = "confirmationCheckin(); return false;"><i class = "glyphicon glyphicon-check"></i> Confirmed Booking</a></center></td>
						</tr>
						<?php
							}
						?>
...
<script type = "text/javascript">
	function confirmationCheckin(anchor){
		var conf = confirm("Are you sure you want to booked it?");
		if(conf){
